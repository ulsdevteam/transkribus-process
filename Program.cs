...
var parseResult = Parser.Default.ParseArguments<ProcessOptions, UploadOptions, CheckOptions, OcrOptions, MsvcOptions>(args);
await parseResult.MapResult(
    ...
    (MsvcOptions options) => { Microservice.Run(config, database, transkribusClient, args); return Task.CompletedTask; },
